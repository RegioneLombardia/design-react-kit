...
<div className='docs'>
  <Callout color='success' highlight>
    ...
    <CalloutText>
      ...
      Inoltre, poichè il significato dell'icona non sempre risulta chiaro per gli utenti anche per gli utenti normodotati, è fortemente consigliato aggiungere un **[tooltip](/docs/documentazione-inserimento-tooltip--documentazione#tooltip)** per aiutare la comprensione.
```tsx
