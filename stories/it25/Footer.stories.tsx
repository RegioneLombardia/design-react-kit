      ...
      <Row>
        <Col sm={3}>
          <div className="it25-footer-logo d-flex justify-content-center align-items-center">
            <img src="../static/img/logo-saf-lombardia.png" alt="logo scuola alta formazione lombardia" className="img-fluid"/>
          </div>
        </Col>
        <Col sm={3}>
          <div className="it25-footer-logo d-flex justify-content-center align-items-center">
            <img src="../static/img/logo-cna-lombardia-bianco.png" alt="logo scuola alta formazione lombardia" className="img-fluid"/>
          </div>
        </Col>
        <Col sm={3}>
