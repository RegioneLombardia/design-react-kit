  ...
  <Row className='justify-content-md-center'>
    <Col md={10} className='my-4'>
      ...
      <p className='text-center'>
        <span className='small'> Versione corrente: <strong>v1.2.4</strong><br/>
          (basata su Design-React-Kit Italia <strong>v5.9.1</strong> e Bootstrap Regione Lombardia <strong>v2.6.1</strong>)</span>
      </p>
