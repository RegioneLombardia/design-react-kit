  ...
  <Row className='justify-content-md-center'>
    <Col md={10} className='my-4'>
      ...
      <p className='text-center'>
        <span className='small'> Versione corrente: <strong>v1.0.0-alpha</strong><br/>
          (basata su Design-React-Kit Italia <strong>v5.3.0</strong> e Bootstrap Regione Lombardia <strong>rl2.3.0</strong>)</span>
      </p>
