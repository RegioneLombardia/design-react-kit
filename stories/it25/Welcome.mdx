...
<Container>
  <Row className='justify-content-md-center'>
    <Col md={10} className='my-4'>
      ...
      <img style={{height:"85px"}} src="../static/img/Regione-Lombardia-Stemma.png"
      ...
      <p>
        Il Design React Kit è un <b>set di componenti open-source per React</b> conforme alle <a href='static/Linee-guida_Applicativi-web_Regione-Lombardia_202305.pdf' target='_blank' rel='noopener noreferrer'>Linee Guida per il design degli Applicativi Web della Regione Lombardia<i className='it-external-link' /></a>, costruito sulle basi della libreria
