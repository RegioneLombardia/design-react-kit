...
const Rating = ({
  ...
  return /* @__PURE__ */ e.createElement(
    ...
    safeInputs.map((id, i) => {
      ...
      ), /* @__PURE__ */ e.createElement(Label, { className: "full", for: id }, /* @__PURE__ */ e.createElement(Icon, { icon: "it-star-full", size: "sm" }), /* @__PURE__ */ e.createElement("span", { className: "visually-hidden" }, labelFn(currentValue))));
    })
  );
};
