...
const ExampleWithHooks = () => {
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(Button, { color: "danger", size: "lg", innerRef: targetRef, onClick: togglePopover }, "Clicca per attivare/disattivare il popover"), /* @__PURE__ */ React.createElement(Popover, { placement: "right", target: targetRef, isOpen: popoverOpen, toggle: togglePopover }, /* @__PURE__ */ React.createElement(PopoverHeader, null, "Titolo del popover"), /* @__PURE__ */ React.createElement(PopoverBody, null, "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc vel finibus augue.")));
};
const Example = {
...
const ElementiDisabilitatiWithHooks = () => {
  const [popoverOpen, setPopoverOpen] = reactExports.useState(false);
  const targetRef = reactExports.useRef(null);
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("span", { ref: targetRef }, /* @__PURE__ */ React.createElement(Button, { color: "primary", disabled: true, style: {
    pointerEvents: "none"
  } }, "Popover disabilitato")), /* @__PURE__ */ React.createElement(Popover, { placement: "right", target: targetRef, trigger: "hover", toggle: () => setPopoverOpen(!popoverOpen), isOpen: popoverOpen }, /* @__PURE__ */ React.createElement(PopoverHeader, null, "Titolo del popover"), /* @__PURE__ */ React.createElement(PopoverBody, null, "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc vel finibus augue.")));
};
...
const DirezioniWithHooks = () => {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "d-flex flex-column" }, /* @__PURE__ */ React.createElement("div", { className: "mx-auto align-self-center p-2" }, /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement(Button, { className: "me-1", color: "secondary", innerRef: targetRefSx, onClick: () => {
    ...
    setPopoverOpenSx(!popoverOpenSx);
  } }, /* @__PURE__ */ React.createElement(PopoverBody, null, "Vivamus sagittis lacus vel augue laoreet rutrum faucibus")))), /* @__PURE__ */ React.createElement("div", { className: "mx-auto align-self-center p-2" }, /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement(Button, { className: "me-1", color: "secondary", innerRef: targetRefDx, onClick: () => {
    ...
    setPopoverOpenDx(!popoverOpenDx);
  } }, /* @__PURE__ */ React.createElement(PopoverBody, null, "Vivamus sagittis lacus vel augue laoreet rutrum faucibus")))), /* @__PURE__ */ React.createElement("div", { className: "mx-auto align-self-center p-2" }, /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement(Button, { className: "me-1", color: "secondary", innerRef: targetRefAlto, onClick: () => {
    ...
    setPopoverOpenAlto(!popoverOpenAlto);
  } }, /* @__PURE__ */ React.createElement(PopoverBody, null, "Vivamus sagittis lacus vel augue laoreet rutrum faucibus")))), /* @__PURE__ */ React.createElement("div", { className: "mx-auto align-self-center p-2" }, /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement(Button, { className: "me-1", color: "secondary", innerRef: targetRefBasso, onClick: () => {
...
const TitoloIconaLinkWithHooks = () => {
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(Button, { color: "secondary", innerRef: targetRef, onClick: togglePopover }, "Popover con icona e link"), /* @__PURE__ */ React.createElement(Popover, { placement: "right", target: targetRef, isOpen: popoverOpen, toggle: togglePopover }, /* @__PURE__ */ React.createElement(PopoverHeader, null, /* @__PURE__ */ React.createElement(Icon, { icon: "it-help-circle", "aria-hidden": true }), "Titolo con icona"), /* @__PURE__ */ React.createElement(PopoverBody, null, "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc vel finibus augue.", /* @__PURE__ */ React.createElement("a", { href: "#", className: "popover-inner-link" }, "More info", /* @__PURE__ */ React.createElement(Icon, { icon: "it-arrow-right", "aria-hidden": true })))));
};
...
const ModalitàHoverWithHooks = () => {
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(Button, { color: "secondary", innerRef: targetRef }, "Apertura in Hover"), /* @__PURE__ */ React.createElement(Popover, { placement: "right", trigger: "hover", target: targetRef, isOpen: popoverOpen, toggle: togglePopover }, /* @__PURE__ */ React.createElement(PopoverHeader, null, "Popover in Hover"), /* @__PURE__ */ React.createElement(PopoverBody, null, "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc vel finibus augue.")));
};
const ModalitàHover = {
...
const ClickSuccessivoWithHooks = () => {
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(Button, { tabIndex: 0, color: "danger", innerRef: targetRef }, "Popover richiudibile"), /* @__PURE__ */ React.createElement(Popover, { placement: "right", trigger: "focus", target: targetRef, isOpen: popoverOpen, toggle: togglePopover }, /* @__PURE__ */ React.createElement(PopoverHeader, null, "Dismissible popover"), /* @__PURE__ */ React.createElement(PopoverBody, null, "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc vel finibus augue.")));
};
