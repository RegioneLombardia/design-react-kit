...
const Esempi = {
  render: () => /* @__PURE__ */ React.createElement(BottomNav, null, /* @__PURE__ */ React.createElement(BottomNavItem, { label: "messaggi" }), /* @__PURE__ */ React.createElement(BottomNavItem, { label: "immagini", iconName: "it-camera" }), /* @__PURE__ */ React.createElement(BottomNavItem, { label: "documenti", iconName: "it-file" }))
};
const Esempi4Links = {
  render: () => /* @__PURE__ */ React.createElement(BottomNav, null, /* @__PURE__ */ React.createElement(BottomNavItem, { label: "messaggi" }), /* @__PURE__ */ React.createElement(BottomNavItem, { label: "immagini", iconName: "it-camera" }), /* @__PURE__ */ React.createElement(BottomNavItem, { label: "documenti", iconName: "it-file" }), /* @__PURE__ */ React.createElement(BottomNavItem, { label: "preferiti", iconName: "it-star-outline" }))
};
const EsempioBadge = {
  render: () => /* @__PURE__ */ React.createElement(BottomNav, null, /* @__PURE__ */ React.createElement(BottomNavItem, { label: "messaggi", badge: 1, srText: "- 1 da leggere" }), /* @__PURE__ */ React.createElement(BottomNavItem, { label: "immagini", badge: 2, iconName: "it-camera", srText: "- 2 da vedere", active: true }), /* @__PURE__ */ React.createElement(BottomNavItem, { label: "documenti", badge: 88, iconName: "it-file", srText: "- 88 da esaminare" }), /* @__PURE__ */ React.createElement(BottomNavItem, { label: "preferiti", iconName: "it-star-outline" }), /* @__PURE__ */ React.createElement(BottomNavItem, { label: "preferenze", iconName: "it-settings" }))
};
const Alert = {
  render: () => /* @__PURE__ */ React.createElement(BottomNav, null, /* @__PURE__ */ React.createElement(BottomNavItem, { alert: true, label: "messaggi", srText: "- nuovo contenuto disponibile" }), /* @__PURE__ */ React.createElement(BottomNavItem, { label: "immagini", iconName: "it-camera" }), /* @__PURE__ */ React.createElement(BottomNavItem, { alert: true, label: "documenti", iconName: "it-file", srText: "- nuovo contenuto disponibile" }), /* @__PURE__ */ React.createElement(BottomNavItem, { label: "preferiti", iconName: "it-star-outline" }), /* @__PURE__ */ React.createElement(BottomNavItem, { label: "preferenze", iconName: "it-settings" }))
};
Esempi.parameters = {
  ...Esempi.parameters,
  docs: {
