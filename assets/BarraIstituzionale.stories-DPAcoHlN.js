...
import { T as TopBar } from "./TopBar-CXaBoItx.js";
...
const BarraIstituzionale = ({
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "it-header-center-wrapper it25-barra-ist" }, /* @__PURE__ */ React.createElement(Container, { fluid: true }, /* @__PURE__ */ React.createElement(Row, null, /* @__PURE__ */ React.createElement(Col, { sm: 12 }, /* @__PURE__ */ React.createElement("div", { className: "it-header-center-content-wrapper" }, /* @__PURE__ */ React.createElement("div", { className: "it-brand-wrapper" }, HamburgerButton, /* @__PURE__ */ React.createElement("a", { href: "#" }, /* @__PURE__ */ React.createElement("img", { src: "../static/img/logo-rl.png", alt: "logo regione lombardia", className: "it25-header-logo d-none d-md-block" }), /* @__PURE__ */ React.createElement("div", { className: "it-brand-text" }, acronym, " ", /* @__PURE__ */ React.createElement("span", { className: "d-none d-md-inline" }, applicationName)))), search && /* @__PURE__ */ React.createElement(Search, null))))));
};
const Search = () => {
