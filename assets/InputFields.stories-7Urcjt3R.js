...
import { A as Autocomplete } from "./react-r1RIZdW4.js";
...
const PasswordConIcone = {
  render: () => {
    return /* @__PURE__ */ e.createElement(Form, null, /* @__PURE__ */ e.createElement(Container, null, /* @__PURE__ */ e.createElement(Row, null, /* @__PURE__ */ e.createElement(Col, { sm: 4 }, /* @__PURE__ */ e.createElement("div", { className: "mb-4" }, "Stato inattivo"), /* @__PURE__ */ e.createElement(FormGroup, null, /* @__PURE__ */ e.createElement(Input, { hasIconLeft: true, iconLeft: /* @__PURE__ */ e.createElement(Icon, { "aria-hidden": true, icon: "it-key", size: "sm" }), id: "exampleInputPassword4", label: "Password", type: "password" }), /* @__PURE__ */ e.createElement("small", { className: "form-text info it25-valid-info-text-patch" }, "Inserisci almeno 8 caratteri"))), /* @__PURE__ */ e.createElement(Col, { sm: 4 }, /* @__PURE__ */ e.createElement("div", { className: "mb-4" }, "Stato attivo"), /* @__PURE__ */ e.createElement(FormGroup, null, /* @__PURE__ */ e.createElement(Input, { hasIconLeft: true, iconLeft: /* @__PURE__ */ e.createElement(Icon, { "aria-hidden": true, icon: "it-key", size: "sm" }), id: "exampleInputPassword5", label: "Password", type: "password", className: "active", value: "abcdefg12" }), /* @__PURE__ */ e.createElement("small", { className: "form-text info it25-valid-info-text-patch" }, "Inserisci almeno 8 caratteri"))), /* @__PURE__ */ e.createElement(Col, { sm: 4 }, /* @__PURE__ */ e.createElement("div", { className: "mb-4" }, "Stato disabilitato"), /* @__PURE__ */ e.createElement(FormGroup, null, /* @__PURE__ */ e.createElement(Input, { hasIconLeft: true, iconLeft: /* @__PURE__ */ e.createElement(Icon, { "aria-hidden": true, icon: "it-key", size: "sm" }), id: "exampleInputPassword6", label: "Password", type: "password", className: "active", disabled: true, value: "abcdefg12" }), /* @__PURE__ */ e.createElement("small", { className: "form-text info it25-valid-info-text-patch" }, "Inserisci almeno 8 caratteri"))))));
  }
};
const SearchField = {
  render: () => {
