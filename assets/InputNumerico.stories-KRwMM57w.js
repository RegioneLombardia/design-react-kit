...
const InputNumericoDimensionamentoHooks = () => {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: "w-100" }, /* @__PURE__ */ React.createElement(Input, { id: "example-w100", type: "number", label: "Input Number inserito in una colonna a tutta larghezza", incrementLabel: "Aumenta il valore  di 1", decrementLabel: "Diminuisci il valore di 1", value, onChange: (ev) => {
    setValue(ev.target.value);
  } })), /* @__PURE__ */ React.createElement("div", { className: "w-50 mt-5" }, /* @__PURE__ */ React.createElement(Input, { id: "example-w50", type: "number", label: "Input Number inserito in una colonna di larghezza 50%", incrementLabel: "Aumenta il valore  di 1", decrementLabel: "Diminuisci il valore di 1", value: value50, onChange: (ev) => {
...
const InputNumericoStepsHooks = () => {
  const [value, setValue] = reactExports.useState("100");
  return /* @__PURE__ */ React.createElement(Input, { id: "example-steps", type: "number", label: "Min, Max & Step", incrementLabel: "Aumenta il valore  di 500", decrementLabel: "Diminuisci il valore di 500", value, min: -2e3, max: 15e3, step: 500, onChange: (ev) => {
    setValue(ev.target.value);
  } });
};
...
const InputNumericoDisabilitato = {
  render: () => {
    return /* @__PURE__ */ React.createElement(Input, { type: "number", label: "Disabled", value: "50", min: 0, max: 100, disabled: true });
  }
};
...
const InputNumericoPercentualeHooks = () => {
  const [value, setValue] = reactExports.useState("100");
  return /* @__PURE__ */ React.createElement(Input, { id: "example-percentage", addonText: "%", type: "percentage", label: "Percentage", incrementLabel: "Aumenta il valore in percentuale di 1", decrementLabel: "Diminuisci il valore in percentuale di 1", value, min: 0, max: 100, onChange: (ev) => {
    setValue(ev.target.value);
  } });
};
...
const InputNumericoRidimensionamentoHooks = () => {
  const [value, setValue] = reactExports.useState("100");
  return /* @__PURE__ */ React.createElement(Input, { id: "example-adaptive", type: "adaptive", label: "Ridimensionamento", incrementLabel: "Aumenta il valore  di 1", decrementLabel: "Diminuisci il valore di 1", value, placeholder: "0", min: 0, max: 99999999999, onChange: (ev) => {
    setValue(ev.target.value);
  } });
};
