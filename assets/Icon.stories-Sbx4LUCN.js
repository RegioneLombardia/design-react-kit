...
import { I as Icon, i as iconsList } from "./Icon-CMQf0osR.js";
...
const EsempioInterattivo = {
  render: ({
    ...
    className,
    color
  }) => /* @__PURE__ */ React.createElement(Icon, { icon, size, title, padding, color, className }),
  args: {
    icon: "it-tool",
    title: "Alt Text",
    size: "",
...
const EsempioDimensioni = {
  render: ({
    ...
    return /* @__PURE__ */ React.createElement(React.Fragment, null, dimensions.map((size) => /* @__PURE__ */ React.createElement(Icon, { key: size, icon, size, padding, color, className })));
  },
  args: {
...
const EsempioColori = {
  render: ({
    ...
    return /* @__PURE__ */ React.createElement(React.Fragment, null, ["primary", "secondary", "success", "warning", "danger"].map((color) => /* @__PURE__ */ React.createElement(Icon, { key: color, icon, color, className: "bg-grey" })), ["light", "white"].map((color) => /* @__PURE__ */ React.createElement(Icon, { key: color, icon, color, className: "bg-dark" })));
  },
  args: {
    icon: "it-check-circle"
  }
...
const EsempioAllineamento = {
  render: () => {
    return /* @__PURE__ */ React.createElement("div", { style: {
      lineHeight: "4em"
    } }, /* @__PURE__ */ React.createElement(Icon, { className: "bg-light align-bottom", icon: "it-check-circle" }), /* @__PURE__ */ React.createElement(Icon, { className: "bg-light align-middle", icon: "it-check-circle" }), /* @__PURE__ */ React.createElement(Icon, { className: "bg-light align-top", icon: "it-check-circle" }));
  }
};
const ListaIcone = {
  render: () => {
...
const EsempioLoghiEsterni = {
  render: () => {
    return /* @__PURE__ */ React.createElement("div", { style: {
      lineHeight: "4em"
    } }, /* @__PURE__ */ React.createElement(Icon, { icon: "https://upload.wikimedia.org/wikipedia/commons/1/12/Palermo-Stemma_%281999%29.svg", title: "Stemma Palermo" }), /* @__PURE__ */ React.createElement(Icon, { icon: "https://upload.wikimedia.org/wikipedia/commons/3/31/Roma-Stemma-2.svg", size: "lg", title: "Stemma Roma" }), /* @__PURE__ */ React.createElement(Icon, { icon: "https://upload.wikimedia.org/wikipedia/commons/9/93/CoA_Citt%C3%A0_di_Milano.svg", size: "xl", title: "Stemma Milano" }));
  }
};
