...
const _VarianteBottoni = {
  render: () => {
    return /* @__PURE__ */ React.createElement(ButtonGroup, { className: "d-flex justify-content-around" }, /* @__PURE__ */ React.createElement(Dropdown, null, /* @__PURE__ */ React.createElement(DropdownToggle, { color: "primary", caret: true }, "Apri dropdown"), /* @__PURE__ */ React.createElement(DropdownMenu, null, /* @__PURE__ */ React.createElement(LinkList, null, /* @__PURE__ */ React.createElement(LinkListItem, { inDropdown: true }, "Azione 1"), /* @__PURE__ */ React.createElement(LinkListItem, { inDropdown: true }, "Azione 2"), /* @__PURE__ */ React.createElement(LinkListItem, { inDropdown: true }, "Azione 3")))), /* @__PURE__ */ React.createElement(Dropdown, null, /* @__PURE__ */ React.createElement(DropdownToggle, { color: "secondary", caret: true }, "Apri dropdown"), /* @__PURE__ */ React.createElement(DropdownMenu, null, /* @__PURE__ */ React.createElement(LinkList, null, /* @__PURE__ */ React.createElement(LinkListItem, { inDropdown: true }, "Azione 1"), /* @__PURE__ */ React.createElement(LinkListItem, { inDropdown: true }, "Azione 2"), /* @__PURE__ */ React.createElement(LinkListItem, { inDropdown: true }, "Azione 3")))), /* @__PURE__ */ React.createElement(Dropdown, null, /* @__PURE__ */ React.createElement(DropdownToggle, { color: "danger", caret: true }, "Apri dropdown"), /* @__PURE__ */ React.createElement(DropdownMenu, null, /* @__PURE__ */ React.createElement(LinkList, null, /* @__PURE__ */ React.createElement(LinkListItem, null, "Azione 1"), /* @__PURE__ */ React.createElement(LinkListItem, null, "Azione 2"), /* @__PURE__ */ React.createElement(LinkListItem, null, "Azione 3")))));
  },
  //Aggiungo del margine alla storia così da visualizzare il bordo onClick correttamente
  decorators: [(Story) => /* @__PURE__ */ React.createElement("div", { className: "m-2" }, /* @__PURE__ */ React.createElement(Story, null))]
};
const _Esempi = {
  render: () => {
    return /* @__PURE__ */ React.createElement("section", null, /* @__PURE__ */ React.createElement(Dropdown, { className: "me-3" }, /* @__PURE__ */ React.createElement(DropdownToggle, { color: "primary", caret: true }, "Apri dropdown"), /* @__PURE__ */ React.createElement(DropdownMenu, null, /* @__PURE__ */ React.createElement(LinkList, null, /* @__PURE__ */ React.createElement(LinkListItem, { inDropdown: true }, "Azione 1"), /* @__PURE__ */ React.createElement(LinkListItem, { inDropdown: true }, "Azione 2"), /* @__PURE__ */ React.createElement(LinkListItem, { inDropdown: true }, "Azione 3")))));
  },
  parameters: {
    layout: "centered"
  },
