import { a as __toESM, b as __commonJS } from "./chunk-H6MOWX77-D-wEvi8z.js";
import { i as iv, c as cv, y as yv, a as y, D as Dg, N as Na, b as av, d as Nm, L as La, $ as $a, Q as Qe } from "./index-CX5rBMF0.js";
...
var require_freeGlobal = __commonJS({ "../../node_modules/lodash/_freeGlobal.js"(exports, module) {
  var freeGlobal = typeof global == "object" && global && global.Object === Object && global;
  module.exports = freeGlobal;
} });
var require_root = __commonJS({ "../../node_modules/lodash/_root.js"(exports, module) {
...
var require_Symbol = __commonJS({ "../../node_modules/lodash/_Symbol.js"(exports, module) {
  var root = require_root(), Symbol2 = root.Symbol;
  module.exports = Symbol2;
} });
var require_getRawTag = __commonJS({ "../../node_modules/lodash/_getRawTag.js"(exports, module) {
...
var require_objectToString = __commonJS({ "../../node_modules/lodash/_objectToString.js"(exports, module) {
...
var require_baseGetTag = __commonJS({ "../../node_modules/lodash/_baseGetTag.js"(exports, module) {
...
var require_isObject = __commonJS({ "../../node_modules/lodash/isObject.js"(exports, module) {
...
var require_overArg = __commonJS({ "../../node_modules/lodash/_overArg.js"(exports, module) {
...
var require_getPrototype = __commonJS({ "../../node_modules/lodash/_getPrototype.js"(exports, module) {
  var overArg = require_overArg(), getPrototype = overArg(Object.getPrototypeOf, Object);
  module.exports = getPrototype;
} });
var require_isObjectLike = __commonJS({ "../../node_modules/lodash/isObjectLike.js"(exports, module) {
  function isObjectLike(value) {
    return value != null && typeof value == "object";
  }
  module.exports = isObjectLike;
} });
var require_isPlainObject = __commonJS({ "../../node_modules/lodash/isPlainObject.js"(exports, module) {
...
var require_isArray = __commonJS({ "../../node_modules/lodash/isArray.js"(exports, module) {
  var isArray2 = Array.isArray;
  module.exports = isArray2;
} });
var require_isString = __commonJS({ "../../node_modules/lodash/isString.js"(exports, module) {
...
function generateCode(ast2, compact = false) {
  return escodegen.generate(ast2, compact ? COMPACT_OPTIONS : PRETTY_OPTIONS);
}
function generateObjectCode(ast2, compact = false) {
  return compact ? generateCompactObjectCode(ast2) : generateCode(ast2);
}
function generateCompactObjectCode(ast2) {
  let result = generateCode(ast2, true);
  return result.endsWith(" }") || (result = `${result.slice(0, -1)} }`), result;
}
function generateArrayCode(ast2, compact = false) {
  return compact ? generateCompactArrayCode(ast2) : generateMultilineArrayCode(ast2);
}
function generateMultilineArrayCode(ast2) {
  let result = generateCode(ast2);
...
function parse3(value) {
  let ast2 = acornParser.parse(`(${value})`, { ecmaVersion: 2020 }), parsingResult = { inferredType: { type: "Unknown" }, ast: ast2 };
  if (ast2.body[0] != null) {
    let rootNode = ast2.body[0];
...
function generateArray({ inferredType, ast: ast2 }) {
  let { depth } = inferredType;
  if (depth <= 2) {
    let compactArray = generateArrayCode(ast2, true);
    if (!$a(compactArray)) return y(compactArray);
  }
  return y(ARRAY_CAPTION, generateArrayCode(ast2));
}
function generateObject({ inferredType, ast: ast2 }) {
  let { depth } = inferredType;
  if (depth === 1) {
    let compactObject = generateObjectCode(ast2, true);
    if (!$a(compactObject)) return y(compactObject);
  }
  return y(OBJECT_CAPTION, generateObjectCode(ast2));
}
...
function generateFunc({ inferredType, ast: ast2 }) {
  let { identifier } = inferredType;
  if (identifier != null) return y(getPrettyIdentifier(inferredType), generateCode(ast2));
  let prettyCaption = generateCode(ast2, true);
  return $a(prettyCaption) ? y(FUNCTION_CAPTION, generateCode(ast2)) : y(prettyCaption);
}
...
var import_isFunction = __toESM(require_isFunction()), import_isPlainObject = __toESM(require_isPlainObject()), import_isString = __toESM(require_isString());
...
}, defaultResolver = (rawDefaultProp) => y(rawDefaultProp.toString()), DEFAULT_TYPE_RESOLVERS = { string: stringResolver, object: objectResolver, function: functionResolver, default: defaultResolver };
...
function prettyObject(ast2, compact = false) {
  return cleanPropTypes(generateObjectCode(ast2, compact));
}
function prettyArray(ast2, compact = false) {
...
function generateTypeFromString(value, originalTypeName) {
  let { inferredType, ast: ast2 } = inspectValue(value), { type } = inferredType, short, compact, full;
  switch (type) {
    case "Identifier":
    case "Literal":
    ...
    case "Object": {
      let { depth } = inferredType;
      short = OBJECT_CAPTION, compact = depth === 1 ? prettyObject(ast2, true) : null, full = prettyObject(ast2);
      break;
    }
    case "Element": {
      let { identifier } = inferredType;
    ...
    case "Array": {
      let { depth } = inferredType;
      short = ARRAY_CAPTION, compact = depth <= 2 ? prettyArray(ast2, true) : null, full = prettyArray(ast2);
      break;
    }
    default:
...
function generateShape(type, extractedProp) {
  let fields = Object.keys(type.value).map((key) => `${key}: ${generateType(type.value[key], extractedProp).full}`).join(", "), { inferredType, ast: ast2 } = inspectValue(`{ ${fields} }`), { depth } = inferredType;
  return createTypeDef({ name: "shape", short: OBJECT_CAPTION, compact: depth === 1 && ast2 ? prettyObject(ast2, true) : null, full: ast2 ? prettyObject(ast2) : null });
}
...
function getPropDefs(component, section) {
  ...
  !Na(component) && !component.propTypes && isMemo(component) && (processedComponent = component.type);
...
var renderJsx = (code2, options) => {
  if (typeof code2 > "u") return logger.warn("Too many skip or undefined component"), null;
  let renderedJSX = code2, Type = renderedJSX.type;
  ...
  return React.Children.map(code2, (c2) => {
...
var parameters = { docs: { story: { inline: true }, extractArgTypes, extractComponentDescription: iv } }, decorators = [jsxDecorator], argTypesEnhancers = [cv];
export {
  applyDecorators,
  argTypesEnhancers,
  decorators,
