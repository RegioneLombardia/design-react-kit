...
import { H as HeaderBrand, a as HeaderRightZone } from "./HeaderRightZone-BTAzq9Rl.js";
import { H as HeaderSocialsZone, a as HeaderSearch } from "./HeaderSocialsZone-M_ocCJLF.js";
...
import { D as Dropdown, a as DropdownToggle } from "./DropdownToggle-CxU9U32Q.js";
...
const CenterHeader = ({
  ...
  return /* @__PURE__ */ React.createElement(Header, { type: "center", theme, small: true }, /* @__PURE__ */ React.createElement(HeaderContent, null, /* @__PURE__ */ React.createElement(HeaderBrand, { iconName: "it-code-circle", iconAlt: "it code circle icon" }, /* @__PURE__ */ React.createElement("h2", null, "Lorem Ipsum Lorem Ipsum"), /* @__PURE__ */ React.createElement("h3", null, "Inserire qui la tag line")), /* @__PURE__ */ React.createElement(HeaderRightZone, null, /* @__PURE__ */ React.createElement(HeaderSocialsZone, { label: "Seguici su" }, /* @__PURE__ */ React.createElement("ul", null, /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("a", { href: "#", "aria-label": "Facebook", target: "_blank" }, /* @__PURE__ */ React.createElement(Icon, { icon: "it-facebook" }))), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("a", { href: "#", "aria-label": "Github", target: "_blank" }, /* @__PURE__ */ React.createElement(Icon, { icon: "it-github" }))), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("a", { href: "#", "aria-label": "Twitter", target: "_blank" }, /* @__PURE__ */ React.createElement(Icon, { icon: "it-twitter" }))))), /* @__PURE__ */ React.createElement(HeaderSearch, { label: "Cerca", iconName: "it-search" }))));
};
const NavHeader = ({
  theme
}) => {
  return /* @__PURE__ */ React.createElement(Header, { type: "navbar", theme }, /* @__PURE__ */ React.createElement(HeaderContent, { expand: "lg", megamenu: true }, /* @__PURE__ */ React.createElement(HeaderToggler, { onClick: () => {
  }, "aria-controls": "nav1", "aria-expanded": "false", "aria-label": "Toggle navigation" }, /* @__PURE__ */ React.createElement(Icon, { icon: "it-burger" })), /* @__PURE__ */ React.createElement(Collapse, { navbar: true, header: true, onOverlayClick: () => {
  } }, /* @__PURE__ */ React.createElement("div", { className: "menu-wrapper" }, /* @__PURE__ */ React.createElement(Nav, { navbar: true }, /* @__PURE__ */ React.createElement(NavItem, { active: true }, /* @__PURE__ */ React.createElement(NavLink, { href: "#", active: true }, /* @__PURE__ */ React.createElement("span", null, "link 1 active "), /* @__PURE__ */ React.createElement("span", { className: "visually-hidden" }, "current"))), /* @__PURE__ */ React.createElement(NavItem, null, /* @__PURE__ */ React.createElement(NavLink, { href: "#", disabled: true }, "Link 2")), /* @__PURE__ */ React.createElement(NavItem, null, /* @__PURE__ */ React.createElement(NavLink, { href: "#" }, "Link 3")), /* @__PURE__ */ React.createElement(NavItem, null, /* @__PURE__ */ React.createElement(NavLink, { href: "#" }, "Link 4")), /* @__PURE__ */ React.createElement(Dropdown, { inNavbar: true }, /* @__PURE__ */ React.createElement(DropdownToggle, { inNavbar: true, caret: true }, /* @__PURE__ */ React.createElement("span", null, "Menu Dropdown")), /* @__PURE__ */ React.createElement(DropdownMenu, null, /* @__PURE__ */ React.createElement(LinkList, null, /* @__PURE__ */ React.createElement(LinkListItem, { inDropdown: true, href: "#" }, /* @__PURE__ */ React.createElement("span", null, "Link list 1")), /* @__PURE__ */ React.createElement(LinkListItem, { inDropdown: true, href: "#" }, /* @__PURE__ */ React.createElement("span", null, "Link list 2")), /* @__PURE__ */ React.createElement(LinkListItem, { inDropdown: true, href: "#" }, /* @__PURE__ */ React.createElement("span", null, "Link list 3")), /* @__PURE__ */ React.createElement(LinkListItem, { inDropdown: true, href: "#" }, /* @__PURE__ */ React.createElement("span", null, "Link list 4"))))), /* @__PURE__ */ React.createElement(MegamenuItem, { itemName: "Megamenu con Immagine e Descrizione" }, /* @__PURE__ */ React.createElement(Row, null, /* @__PURE__ */ React.createElement(MegamenuHighlightColumn, { xs: "12", lg: "4", description: true }, /* @__PURE__ */ React.createElement("div", { className: "ratio ratio-21x9 lightgrey-bg-a1 mb-4 rounded" }, /* @__PURE__ */ React.createElement("figure", { className: "figure" }, /* @__PURE__ */ React.createElement("img", { src: "https://placehold.co/560x240/ebebeb/808080/?text=Immagine", className: "figure-img img-fluid rounded", alt: "Segnaposto" }))), /* @__PURE__ */ React.createElement("p", null, "Omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam.")), /* @__PURE__ */ React.createElement(Col, { xs: "12", lg: "8" }, /* @__PURE__ */ React.createElement("div", { className: "it-heading-link-wrapper" }, /* @__PURE__ */ React.createElement("a", { className: "it-heading-link", href: "#" }, /* @__PURE__ */ React.createElement(Icon, { className: "icon icon-sm me-2 mb-1", icon: "it-arrow-right-triangle" }), /* @__PURE__ */ React.createElement("span", null, "Esplora la sezione megamenu"))), /* @__PURE__ */ React.createElement(Row, null, /* @__PURE__ */ React.createElement(Col, { xs: "12", lg: "6" }, /* @__PURE__ */ React.createElement(LinkList, null, /* @__PURE__ */ React.createElement(LinkListItem, { inDropdown: true, href: "#" }, /* @__PURE__ */ React.createElement(Icon, { className: "me-2", color: "primary", icon: "it-arrow-right-triangle", size: "xs" }), /* @__PURE__ */ React.createElement("span", null, "Link lista 1")), /* @__PURE__ */ React.createElement(LinkListItem, { inDropdown: true, href: "#" }, /* @__PURE__ */ React.createElement(Icon, { className: "me-2", color: "primary", icon: "it-arrow-right-triangle", size: "xs" }), /* @__PURE__ */ React.createElement("span", null, "Link lista 2")), /* @__PURE__ */ React.createElement(LinkListItem, { inDropdown: true, href: "#" }, /* @__PURE__ */ React.createElement(Icon, { className: "me-2", color: "primary", icon: "it-arrow-right-triangle", size: "xs" }), /* @__PURE__ */ React.createElement("span", null, "Link lista 3")))), /* @__PURE__ */ React.createElement(Col, { xs: "12", lg: "6" }, /* @__PURE__ */ React.createElement(LinkList, null, /* @__PURE__ */ React.createElement(LinkListItem, { inDropdown: true, href: "#" }, /* @__PURE__ */ React.createElement(Icon, { className: "me-2", color: "primary", icon: "it-arrow-right-triangle", size: "xs" }), /* @__PURE__ */ React.createElement("span", null, "Link lista 4")), /* @__PURE__ */ React.createElement(LinkListItem, { inDropdown: true, href: "#" }, /* @__PURE__ */ React.createElement(Icon, { className: "me-2", color: "primary", icon: "it-arrow-right-triangle", size: "xs" }), /* @__PURE__ */ React.createElement("span", null, "Link lista 5")), /* @__PURE__ */ React.createElement(LinkListItem, { inDropdown: true, href: "#" }, /* @__PURE__ */ React.createElement(Icon, { className: "me-2", color: "primary", icon: "it-arrow-right-triangle", size: "xs" }), /* @__PURE__ */ React.createElement("span", null, "Link lista 6")))))))))))));
};
const SlimHeader = ({
  theme
}) => {
  return /* @__PURE__ */ React.createElement(Header, { type: "slim", theme }, /* @__PURE__ */ React.createElement(HeaderContent, null, /* @__PURE__ */ React.createElement(HeaderBrand, null, "Ente appartenenza/Owner"), /* @__PURE__ */ React.createElement(HeaderLinkZone, null, /* @__PURE__ */ React.createElement(HeaderToggler, { onClick: () => {
  } }, /* @__PURE__ */ React.createElement("span", null, "Ente appartenenza/Owner"), /* @__PURE__ */ React.createElement(Icon, { icon: "it-expand" })), /* @__PURE__ */ React.createElement(Collapse, { isOpen: true, header: true }, /* @__PURE__ */ React.createElement(LinkList, null, /* @__PURE__ */ React.createElement(LinkListItem, { href: "#" }, "Link 1"), /* @__PURE__ */ React.createElement(LinkListItem, { href: "#", active: true }, "Link 2 Active")))), /* @__PURE__ */ React.createElement(HeaderRightZone, null, /* @__PURE__ */ React.createElement(Dropdown, { inNavbar: true }, /* @__PURE__ */ React.createElement(DropdownToggle, { inNavbar: true, caret: true }, "ITA"), /* @__PURE__ */ React.createElement(DropdownMenu, null, /* @__PURE__ */ React.createElement(Row, null, /* @__PURE__ */ React.createElement(Col, { size: "12" }, /* @__PURE__ */ React.createElement(LinkList, null, /* @__PURE__ */ React.createElement(LinkListItem, { inDropdown: true, href: "#" }, /* @__PURE__ */ React.createElement("span", null, "ITA")), /* @__PURE__ */ React.createElement(LinkListItem, { inDropdown: true, href: "#" }, /* @__PURE__ */ React.createElement("span", null, "ENG"))))))), /* @__PURE__ */ React.createElement("div", { className: "it-access-top-wrapper" }, /* @__PURE__ */ React.createElement(Button, { color: "primary", size: "sm" }, "Accedi")))));
};
const meta = {
...
const CompleteHeaderStory = {
  render: ({
    theme,
    sticky
  }) => /* @__PURE__ */ React.createElement(Headers, { sticky }, /* @__PURE__ */ React.createElement(SlimHeader, { theme }), /* @__PURE__ */ React.createElement("div", { className: "it-nav-wrapper" }, /* @__PURE__ */ React.createElement(CenterHeader, { theme }), /* @__PURE__ */ React.createElement(NavHeader, { theme }))),
  args: {
    theme: "dark"
  },
  argTypes: {
