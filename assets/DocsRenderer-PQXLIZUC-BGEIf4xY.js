const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./index-CHESMHRC.js","./iframe-CCeCdQXR.js","./preload-helper-CQrtv1eE.js","./iframe-Chmy97eT.css"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./preload-helper-CQrtv1eE.js";
import { r as reactExports, e } from "./iframe-CCeCdQXR.js";
import { c as createRoot } from "./client-CJIoTf9X.js";
import { H as HeadersMdx, f as AnchorMdx, h as CodeOrSourceMdx, D as Docs } from "./blocks-BAsBN5ia.js";
import "./index-cQORbDB_.js";
import "./jsx-runtime-CQi0FYWE.js";
  ...
  constructor() {
    this.render = async (context, docsParameter, element) => {
      ...
      return new Promise((resolve, reject) => {
        __vitePreload(async () => {
          const { MDXProvider } = await import("./index-CHESMHRC.js");
          return { MDXProvider };
