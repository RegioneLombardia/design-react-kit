...
import { f as canUseDOM, b as targetPropType, a as TransitionTimeouts, k as keyCodes, h as focusableElements, g as getTarget, j as getOriginalBodyPadding, l as conditionallyUpdateScrollbar, m as mapToCssModules, s as setScrollbarWidth, o as omit, t as tagPropType } from "./utils-BToed_Um.js";
...
import { f as fT } from "./index-DVdwlR73.js";
import { F as Fade } from "./Fade-ZyZ8S0O7.js";
...
const _EsempioBase = {
  render: () => /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "modal-dialog", role: "document" }, /* @__PURE__ */ React.createElement(ModalHeader, null, "Titolo della modale"), /* @__PURE__ */ React.createElement(ModalBody, null, "Il testo del corpo della modale va qui."), /* @__PURE__ */ React.createElement(ModalFooter, null, /* @__PURE__ */ React.createElement(Button, { color: "secondary" }, "Chiudi"), /* @__PURE__ */ React.createElement(Button, { color: "primary" }, "Salva le modifiche"))))
};
const ModaleBaseConBottoneChiusuraHooks = () => {
  const [isOpen, toggleModal] = reactExports.useState(false);
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(Button, { color: "primary", onClick: () => toggleModal(!isOpen) }, "Mostra modale con bottone di chiusura"), /* @__PURE__ */ React.createElement(Modal, { isOpen, toggle: () => toggleModal(!isOpen), labelledBy: "esempio2" }, /* @__PURE__ */ React.createElement(ModalHeader, { toggle: () => toggleModal(!isOpen), id: "esempio2" }, "Titolo della modale"), /* @__PURE__ */ React.createElement(ModalBody, null, /* @__PURE__ */ React.createElement("p", null, "Woohoo, stai leggendo questo testo in una modale!")), /* @__PURE__ */ React.createElement(ModalFooter, null, /* @__PURE__ */ React.createElement(Button, { color: "secondary", onClick: () => toggleModal(!isOpen) }, "Chiudi"), /* @__PURE__ */ React.createElement(Button, { color: "primary", onClick: () => toggleModal(!isOpen) }, "Salva modifiche"))));
};
...
const ModaleBaseHooks = () => {
  const [isOpen, toggleModal] = reactExports.useState(false);
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(Button, { color: "primary", onClick: () => toggleModal(!isOpen) }, "Lancia la demo della modale"), /* @__PURE__ */ React.createElement(Modal, { isOpen, toggle: () => toggleModal(!isOpen), labelledBy: "esempio1" }, /* @__PURE__ */ React.createElement(ModalHeader, { toggle: () => toggleModal(!isOpen), id: "esempio1" }, "Titolo della modale"), /* @__PURE__ */ React.createElement(ModalBody, null, /* @__PURE__ */ React.createElement("p", null, "Woohoo, stai leggendo questo testo in una modale!")), /* @__PURE__ */ React.createElement(ModalFooter, null, /* @__PURE__ */ React.createElement(Button, { color: "primary", onClick: () => toggleModal(!isOpen) }, "Salva modifiche"))));
};
const ModaleBase = {
  render: () => {
...
const ModaleConIconaHooks = () => {
  const [isOpen, toggleModal] = reactExports.useState(false);
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(Button, { color: "primary", onClick: () => toggleModal(!isOpen) }, "Lancia modale con icona"), /* @__PURE__ */ React.createElement(Modal, { isOpen, toggle: () => toggleModal(!isOpen), withIcon: true, labelledBy: "esempio3" }, /* @__PURE__ */ React.createElement(ModalHeader, { icon: "it-info-circle", id: "esempio3" }, "This is a notification message more long than usual"), /* @__PURE__ */ React.createElement(ModalBody, null, /* @__PURE__ */ React.createElement("p", null, "In the various types of information modal dialog, only one button to close dialog is provided.")), /* @__PURE__ */ React.createElement(ModalFooter, null, /* @__PURE__ */ React.createElement(Button, { color: "primary", onClick: () => toggleModal(!isOpen) }, "Ok"))));
};
...
const ModaleConFormInputsHooks = () => {
  const [isOpen, toggleModal] = reactExports.useState(false);
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(Button, { color: "primary", onClick: () => toggleModal(!isOpen) }, "Lancia modale con form"), /* @__PURE__ */ React.createElement(Modal, { isOpen, toggle: () => toggleModal(!isOpen), labelledBy: "esempio4" }, /* @__PURE__ */ React.createElement(ModalHeader, { id: "esempio4", toggle: () => toggleModal(!isOpen) }, "SCEGLI UNA OPZIONE"), /* @__PURE__ */ React.createElement(ModalBody, null, /* @__PURE__ */ React.createElement(FormGroup, { check: true }, /* @__PURE__ */ React.createElement(Input, { name: "gruppo1", type: "radio", id: "radio1", defaultChecked: true }), /* @__PURE__ */ React.createElement(Label, { check: true, htmlFor: "radio1" }, "Opzione 1")), /* @__PURE__ */ React.createElement(FormGroup, { check: true }, /* @__PURE__ */ React.createElement(Input, { name: "gruppo1", type: "radio", id: "radio2" }), /* @__PURE__ */ React.createElement(Label, { check: true, htmlFor: "radio2" }, "Opzione 2")), /* @__PURE__ */ React.createElement(FormGroup, { check: true }, /* @__PURE__ */ React.createElement(Input, { name: "gruppo1", type: "radio", id: "radio3" }), /* @__PURE__ */ React.createElement(Label, { check: true, htmlFor: "radio3" }, "Opzione 3"))), /* @__PURE__ */ React.createElement(ModalFooter, null, /* @__PURE__ */ React.createElement(Button, { outline: true, color: "primary", onClick: () => toggleModal(!isOpen) }, "Chiudi"), /* @__PURE__ */ React.createElement(Button, { color: "primary", onClick: () => toggleModal(!isOpen), disabled: true }, "Ok"))));
};
...
const ModaleConLinkListHooks = () => {
  const [isOpen, toggleModal] = reactExports.useState(false);
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(Button, { color: "primary", onClick: () => toggleModal(!isOpen) }, "Lancia modale con LinkList"), /* @__PURE__ */ React.createElement(Modal, { isOpen, toggle: () => toggleModal(!isOpen), withLinkList: true, labelledBy: "esempio5" }, /* @__PURE__ */ React.createElement(ModalHeader, { id: "esempio5" }, /* @__PURE__ */ React.createElement("span", null, "1."), "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt."), /* @__PURE__ */ React.createElement(ModalBody, null, /* @__PURE__ */ React.createElement(LinkList, null, /* @__PURE__ */ React.createElement(LinkListItem, { className: "icon-left" }, /* @__PURE__ */ React.createElement(Icon, { color: "primary", icon: "it-chevron-right", "aria-hidden": true }), /* @__PURE__ */ React.createElement("span", null, "Link list 1")), /* @__PURE__ */ React.createElement(LinkListItem, { className: "icon-left" }, /* @__PURE__ */ React.createElement(Icon, { color: "primary", icon: "it-chevron-right", "aria-hidden": true }), /* @__PURE__ */ React.createElement("span", null, "Link list 2")), /* @__PURE__ */ React.createElement(LinkListItem, { className: "icon-left" }, /* @__PURE__ */ React.createElement(Icon, { color: "primary", icon: "it-chevron-right", "aria-hidden": true }), /* @__PURE__ */ React.createElement("span", null, "Link list 3")))), /* @__PURE__ */ React.createElement(ModalFooter, null, /* @__PURE__ */ React.createElement(Button, { color: "primary", onClick: () => toggleModal(!isOpen) }, "Ok"))));
};
...
const ModalePopConfirmHooks = () => {
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(Button, { color: "primary", onClick: () => toggleBaseModal(!isOpenBase), className: "me-3" }, "Lancia modale pop-confirm base"), /* @__PURE__ */ React.createElement(Button, { color: "primary", onClick: () => toggleModalWithHeader(!isOpenWithHeader), className: "me-3" }, "Lancia modale pop-confirm con titolo"), /* @__PURE__ */ React.createElement(Modal, { isOpen: isOpenBase, toggle: () => toggleBaseModal(!isOpenBase), popConfirm: true }, /* @__PURE__ */ React.createElement(ModalBody, null, /* @__PURE__ */ React.createElement("p", null, "Font Titillium 14px. Leading 21px.")), /* @__PURE__ */ React.createElement(ModalFooter, null, /* @__PURE__ */ React.createElement(Button, { color: "primary", onClick: () => toggleBaseModal(!isOpenBase), size: "sm" }, "Action one"), /* @__PURE__ */ React.createElement(Button, { color: "secondary", onClick: () => toggleBaseModal(!isOpenBase), size: "sm", outline: true }, "Action two"))), /* @__PURE__ */ React.createElement(Modal, { isOpen: isOpenWithHeader, toggle: () => toggleModalWithHeader(!isOpenWithHeader), popConfirm: true, labelledBy: "esempio6" }, /* @__PURE__ */ React.createElement(ModalHeader, { labelledBy: "esempio6" }, "Popconfirm header"), /* @__PURE__ */ React.createElement(ModalBody, null, /* @__PURE__ */ React.createElement("p", null, "Font Titillium 14px. Leading 21px.")), /* @__PURE__ */ React.createElement(ModalFooter, null, /* @__PURE__ */ React.createElement(Button, { color: "primary", onClick: () => toggleModalWithHeader(!isOpenWithHeader), size: "sm" }, "Action one"), /* @__PURE__ */ React.createElement(Button, { color: "secondary", onClick: () => toggleModalWithHeader(!isOpenWithHeader), size: "sm", outline: true }, "Action two"))));
};
...
const ModaleConContenutoScrollabileHooks = () => {
  const [isOpen, toggleModal] = reactExports.useState(false);
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(Button, { color: "primary", onClick: () => toggleModal(!isOpen) }, "Lancia modale con contenuto scrollabile"), /* @__PURE__ */ React.createElement(Modal, { isOpen, toggle: () => toggleModal(!isOpen), scrollable: true, labelledBy: "esempio8" }, /* @__PURE__ */ React.createElement(ModalHeader, { id: "esempio8" }, "INTESTAZIONE MODALE"), /* @__PURE__ */ React.createElement(ModalBody, null, /* @__PURE__ */ React.createElement("p", null, "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.")), /* @__PURE__ */ React.createElement(ModalFooter, null, /* @__PURE__ */ React.createElement(Button, { color: "primary", outline: true, onClick: () => toggleModal(!isOpen), size: "sm" }, "Chiudi"), /* @__PURE__ */ React.createElement(Button, { color: "primary", onClick: () => toggleModal(!isOpen), size: "sm" }, "Azione Uno"))));
};
...
const CentraturaVerticaleStoryHooks = () => {
  const [isOpen, toggleModal] = reactExports.useState(false);
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(Button, { color: "primary", onClick: () => toggleModal(!isOpen) }, "Lancia la demo della modale"), /* @__PURE__ */ React.createElement(Modal, { isOpen, toggle: () => toggleModal(!isOpen), centered: true, labelledBy: "esempio9" }, /* @__PURE__ */ React.createElement(ModalHeader, { toggle: () => toggleModal(!isOpen), id: "essempio9" }, "Titolo della modale"), /* @__PURE__ */ React.createElement(ModalBody, null, /* @__PURE__ */ React.createElement("p", null, "Woohoo, stai leggendo questo testo in una modale!")), /* @__PURE__ */ React.createElement(ModalFooter, null, /* @__PURE__ */ React.createElement(Button, { color: "secondary", onClick: () => toggleModal(!isOpen) }, "Chiudi"), /* @__PURE__ */ React.createElement(Button, { color: "primary", onClick: () => toggleModal(!isOpen) }, "Salva modifiche"))));
};
...
const AllineamentoASinistraHooks = () => {
  const [isOpen, toggleModal] = reactExports.useState(false);
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(Button, { color: "primary", onClick: () => toggleModal(!isOpen) }, "Lancia la demo della modale a sinistra"), /* @__PURE__ */ React.createElement(Modal, { isOpen, toggle: () => toggleModal(!isOpen), align: "left", scrollable: true, labelledBy: "esempio10" }, /* @__PURE__ */ React.createElement(ModalHeader, { toggle: () => toggleModal(!isOpen), id: "esempio10" }, "This is a notification message"), /* @__PURE__ */ React.createElement(ModalBody, null, /* @__PURE__ */ React.createElement("p", null, "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.")), /* @__PURE__ */ React.createElement(ModalFooter, null, /* @__PURE__ */ React.createElement(Button, { color: "primary", onClick: () => toggleModal(!isOpen) }, "Ok"))));
};
...
const RimuovereLanimazioneHooks = () => {
  const [isOpen, toggleModal] = reactExports.useState(false);
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(Button, { color: "primary", onClick: () => toggleModal(!isOpen) }, "Lancia la demo della modale"), /* @__PURE__ */ React.createElement(Modal, { isOpen, toggle: () => toggleModal(!isOpen), fade: false, labelledBy: "esempio12" }, /* @__PURE__ */ React.createElement(ModalHeader, { toggle: () => toggleModal(!isOpen), id: "esempio12" }, "Titolo della modale"), /* @__PURE__ */ React.createElement(ModalBody, null, /* @__PURE__ */ React.createElement("p", null, "Woohoo, stai leggendo questo testo in una modale!")), /* @__PURE__ */ React.createElement(ModalFooter, null, /* @__PURE__ */ React.createElement(Button, { color: "secondary", onClick: () => toggleModal(!isOpen) }, "Chiudi"), /* @__PURE__ */ React.createElement(Button, { color: "primary", onClick: () => toggleModal(!isOpen) }, "Salva modifiche"))));
};
...
const DimensioniHooks = () => {
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(Button, { color: "primary", onClick: () => {
    setSize("lg");
    toggleModal(true);
  }, className: "me-3" }, "Modale grande"), /* @__PURE__ */ React.createElement(Button, { color: "primary", onClick: () => {
    setSize("sm");
    toggleModal(true);
  } }, "Modale piccola")), /* @__PURE__ */ React.createElement(Modal, { isOpen, toggle: () => toggleModal(!isOpen), size, labelledBy: "esempio13" }, /* @__PURE__ */ React.createElement(ModalHeader, { toggle: () => toggleModal(!isOpen), id: "esempio13" }, "Titolo della modale"), /* @__PURE__ */ React.createElement(ModalBody, null, /* @__PURE__ */ React.createElement("p", null, "Woohoo, stai leggendo questo testo in una modale!")), /* @__PURE__ */ React.createElement(ModalFooter, null, /* @__PURE__ */ React.createElement(Button, { color: "secondary", onClick: () => toggleModal(!isOpen) }, "Chiudi"), /* @__PURE__ */ React.createElement(Button, { color: "primary", onClick: () => toggleModal(!isOpen) }, "Salva modifiche"))));
};
const _Dimensioni = {
  render: () => {
