...
const HeroConSfondo = {
  render: () => /* @__PURE__ */ React.createElement(Hero, null, /* @__PURE__ */ React.createElement(HeroBackground, { src: "https://animals.sandiegozoo.org/sites/default/files/2016-08/animals_hero_mountains.jpg", title: "image title", alt: "imagealt" }))
};
const HeroConSfondoSmall = {
  render: () => /* @__PURE__ */ React.createElement(Hero, { small: true }, /* @__PURE__ */ React.createElement(HeroBackground, { src: "https://animals.sandiegozoo.org/sites/default/files/2016-08/animals_hero_mountains.jpg", title: "image title", alt: "imagealt" }))
};
const HeroConTesto = {
...
const HeroConTestoCentrato = {
  render: () => /* @__PURE__ */ React.createElement(Hero, { centered: true }, /* @__PURE__ */ React.createElement(HeroBody, null, /* @__PURE__ */ React.createElement(HeroCategory, null, "Category"), /* @__PURE__ */ React.createElement(HeroTitle, null, "Heading lorem ipsum dolor sit amet, consetetur sadipscing."), /* @__PURE__ */ React.createElement("p", { className: "d-none d-lg-block" }, "Platea dictumst vestibulum rhoncus est pellentesque elit ullamcorper dignissim cras. Dictum sit amet justo donec enim diam vulputate ut. Eu nisl nunc mi ipsum faucibus."), /* @__PURE__ */ React.createElement(HeroButton, { outline: true, color: "primary" }, "Label button")))
};
