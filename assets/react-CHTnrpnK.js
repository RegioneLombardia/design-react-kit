import { r as reactExports, c as commonjsGlobal, g as getDefaultExportFromCjs } from "./iframe-BdFmv8SM.js";
var accessibleAutocomplete_react_min = { exports: {} };
(function(module, exports) {
  !function(t, e) {
    module.exports = e(reactExports);
  }(commonjsGlobal, function(t) {
    return function() {
      var e = { 680: function(e2) {
        e2.exports = t;
      }, 8952: function(t2, e2, n2) {
        ...
        var r2 = n2(8992), o2 = n2(1664), i = n2(5712), u = n2(4356), a = n2(3556), c = n2(2568), s = o2([].push), l = function(t3) {
          var e3 = 1 === t3, n3 = 2 === t3, o3 = 3 === t3, l2 = 4 === t3, f = 6 === t3, p = 7 === t3, h = 5 === t3 || f;
          return function(d, v, y, g) {
            for (var m, b, x = u(d), w = i(x), O = a(w), S = r2(v, y), E = 0, I = g || c, j = e3 ? I(d, O) : n3 || p ? I(d, 0) : void 0; O > E; E++) if ((h || E in w) && (b = S(m = w[E], E, x), t3)) if (e3) j[E] = b;
            else if (b) switch (t3) {
              case 3:
                return true;
              case 5:
        ...
        t2.exports = function(t3) {
          var e3;
          return r2(t3) && (e3 = t3.constructor, (o2(e3) && (e3 === a || r2(e3.prototype)) || i(e3) && null === (e3 = e3[u])) && (e3 = void 0)), void 0 === e3 ? a : e3;
        };
        ...
        t2.exports = r2 ? i : function(t3) {
          ...
          }(e3 = a(t3), u)) ? n3 : c ? i(e3) : "Object" === (r3 = i(e3)) && o2(e3.callee) ? "Arguments" : r3;
        };
      }, 9968: function(t2, e2, n2) {
        var r2 = n2(5152), o2 = n2(9252), i = n2(9444), u = n2(8352);
        t2.exports = function(t3, e3, n3) {
          for (var a = o2(e3), c = u.f, s = i.f, l = 0; l < a.length; l++) {
            var f = a[l];
        ...
        var r2 = n2(3476), o2 = n2(8352), i = n2(9728);
        t2.exports = function(t3, e3, n3) {
          r2 ? o2.f(t3, e3, i(0, n3)) : t3[e3] = n3;
        };
      }, 2544: function(t2, e2, n2) {
        var r2 = n2(5312), o2 = n2(8352);
        t2.exports = function(t3, e3, n3) {
          return n3.get && r2(n3.get, e3, { getter: true }), n3.set && r2(n3.set, e3, { setter: true }), o2.f(t3, e3, n3);
        };
        ...
        t2.exports = function(t3, e3, n3, a) {
          ...
          if (r2(n3) && i(n3, s, a), a.global) c ? t3[e3] = n3 : u(e3, n3);
            ...
            c ? t3[e3] = n3 : o2.f(t3, e3, { value: n3, enumerable: false, configurable: !a.nonConfigurable, writable: !a.nonWritable });
          }
          return t3;
        };
        ...
        var r2 = n2(6076);
        t2.exports = function(t3, e3, n3) {
          for (var o2 in e3) r2(t3, o2, e3[o2], n3);
          return t3;
        };
        ...
        t2.exports = function(t3, e3) {
          try {
            o2(r2, t3, { value: e3, configurable: true, writable: true });
          } catch (n3) {
            r2[t3] = e3;
          }
          return e3;
        ...
        t2.exports = function(t3, e3) {
          if (c && "string" == typeof t3 && !o2.prepareStackTrace) for (; e3--; ) t3 = i(t3, a, "");
          return t3;
        };
      }, 3696: function(t2, e2, n2) {
        var r2 = n2(3440), o2 = n2(6520), i = n2(9184), u = Error.captureStackTrace;
        t2.exports = function(t3, e3, n3, a) {
          i && (u ? u(t3, e3) : r2(t3, "stack", o2(n3, a)));
        };
        ...
        t2.exports = function(t3, e3) {
          ...
          if (n3 = v ? r2 : y ? r2[d] || a(d, {}) : r2[d] && r2[d].prototype) for (l in e3) {
            if (p = e3[l], f = t3.dontCallGetSet ? (h = o2(n3, l)) && h.value : n3[l], !s(v ? l : d + (y ? "." : "#") + l, t3.forced) && void 0 !== f) {
        ...
        t2.exports = function(t3, e3, n3, f) {
          ...
          if (!h || !d || n3) {
            var v = /./[p], y = e3(p, ""[t3], function(t4, e4, n4, o3, u2) {
              var a2 = e4.exec;
              return a2 === i || a2 === l.exec ? h && !u2 ? { done: true, value: r2(v, e4, n4, o3) } : { done: true, value: r2(t4, n4, e4, o3) } : { done: false };
            });
        ...
        t2.exports = function(t3, e3) {
          return o2(t3), void 0 === e3 ? t3 : i ? u(t3, e3) : function() {
        ...
        t2.exports = function(t3, e3, n3) {
          try {
            return r2(o2(Object.getOwnPropertyDescriptor(t3, e3)[n3]));
          } catch (i) {
          }
        };
        ...
        t2.exports = function(t3, e3, n3) {
          var u, a;
          return i && r2(u = e3.constructor) && u !== n3 && o2(a = u.prototype) && a !== n3.prototype && i(t3, a), t3;
        };
        ...
        t2.exports = function(t3, e3) {
          r2(e3) && "cause" in e3 && o2(t3, "cause", e3.cause);
        };
        ...
        if (u || f.state) {
          ...
          g.get = g.get, g.has = g.has, g.set = g.set, r2 = function(t3, e3) {
        ...
        t2.exports = { set: r2, get: o2, has: i, enforce: function(t3) {
          ...
          return function(e3) {
            var n3;
            if (!c(e3) || (n3 = o2(e3)).type !== t3) throw new v("Incompatible receiver, " + t3 + " required");
            return n3;
          };
        } };
        ...
        var r2 = n2(9957), o2 = n2(4328), i = /#|\.prototype\./, u = function(t3, e3) {
          var n3 = c[a(t3)];
          return n3 === l || n3 !== s && (o2(e3) ? r2(e3) : !!e3);
        ...
        t2.exports = u ? function(t3) {
          ...
          var e3 = r2("Symbol");
          return o2(e3) && i(e3.prototype, a(t3));
        };
        ...
        i(b, h, "Iterator Helper"), t2.exports = function(t3, e3) {
          var n3 = function(n4, r3) {
            r3 ? (r3.iterator = n4.iterator, r3.next = n4.next) : r3 = n4, r3.type = e3 ? v : d, r3.nextHandler = t3, r3.counter = 0, r3.done = false, y(this, r3);
          };
          return n3.prototype = e3 ? m : b, n3;
        };
        ...
        var r2 = n2(1664), o2 = n2(9957), i = n2(4328), u = n2(5152), a = n2(3476), c = n2(6208).CONFIGURABLE, s = n2(9112), l = n2(9104), f = l.enforce, p = l.get, h = String, d = Object.defineProperty, v = r2("".slice), y = r2("".replace), g = r2([].join), m = a && !o2(function() {
          ...
          "Symbol(" === v(h(e3), 0, 7) && (e3 = "[" + y(h(e3), /^Symbol\(([^)]*)\).*$/, "$1") + "]"), n3 && n3.getter && (e3 = "get " + e3), n3 && n3.setter && (e3 = "set " + e3), (!u(t3, "name") || c && t3.name !== e3) && (a ? d(t3, "name", { value: e3, configurable: true }) : t3.name = e3), m && n3 && u(n3, "arity") && t3.length !== n3.arity && d(t3, "length", { value: n3.arity });
          try {
            n3 && u(n3, "constructor") && n3.constructor ? a && d(t3, "prototype", { writable: false }) : t3.prototype && (t3.prototype = void 0);
          } catch (o3) {
          }
          var r3 = f(t3);
          return u(r3, "source") || (r3.source = g(b, "string" == typeof e3 ? e3 : "")), t3;
        };
        ...
        t2.exports = !p || u(function() {
          ...
          var t3 = {}, e3 = {}, n3 = Symbol("assign detection"), o3 = "abcdefghijklmnopqrst";
          return t3[n3] = 7, o3.split("").forEach(function(t4) {
            e3[t4] = t4;
          }), 7 !== p({}, t3)[n3] || a(p({}, e3)).join("") !== o3;
        }) ? function(t3, e3) {
        ...
        var r2, o2 = n2(3951), i = n2(2056), u = n2(8256), a = n2(2560), c = n2(4168), s = n2(8168), l = n2(6504), f = "prototype", p = "script", h = l("IE_PROTO"), d = function() {
          ...
          var t3, e3, n3;
          g = "undefined" != typeof document ? document.domain && r2 ? y(r2) : (e3 = s("iframe"), n3 = "java" + p + ":", e3.style.display = "none", c.appendChild(e3), e3.src = String(n3), (t3 = e3.contentWindow.document).open(), t3.write(v("document.F=Object")), t3.close(), t3.F) : y(r2);
          for (var o3 = u.length; o3--; ) delete g[f][u[o3]];
          return g();
        };
        a[h] = true, t2.exports = Object.create || function(t3, e3) {
          var n3;
          return null !== t3 ? (d[f] = o2(t3), n3 = new d(), d[f] = null, n3[h] = t3) : n3 = g(), void 0 === e3 ? n3 : i.f(n3, e3);
        };
      }, 2056: function(t2, e2, n2) {
        var r2 = n2(3476), o2 = n2(1576), i = n2(8352), u = n2(3951), a = n2(4096), c = n2(1531);
        e2.f = r2 && !o2 ? Object.defineProperties : function(t3, e3) {
          u(t3);
          for (var n3, r3 = a(e3), o3 = c(e3), s = o3.length, l = 0; s > l; ) i.f(t3, n3 = o3[l++], r3[n3]);
          return t3;
        };
        ...
        e2.f = r2 ? i ? function(t3, e3, n3) {
          if (u(t3), e3 = a(e3), u(n3), "function" == typeof t3 && "prototype" === e3 && "value" in n3 && h in n3 && !n3[h]) {
            var r3 = l(t3, e3);
            r3 && r3[h] && (t3[e3] = n3.value, n3 = { configurable: p in n3 ? n3[p] : r3[p], enumerable: f in n3 ? n3[f] : r3[f], writable: false });
          }
          return s(t3, e3, n3);
        } : s : function(t3, e3, n3) {
          if (u(t3), e3 = a(e3), u(n3), o2) try {
            return s(t3, e3, n3);
          } catch (r3) {
          }
        ...
        e2.f = r2 ? f : function(t3, e3) {
          ...
          if (s(t3, e3)) return u(!o2(i.f, t3, e3), t3[e3]);
        };
        ...
        t2.exports = a ? s.getPrototypeOf : function(t3) {
          ...
          return o2(n3) && e3 instanceof n3 ? n3.prototype : e3 instanceof s ? l : null;
        };
        ...
        t2.exports = function(t3, e3) {
          ...
          for (; e3.length > s; ) o2(r3, n3 = e3[s++]) && (~u(l, n3) || c(l, n3));
          return l;
        };
        ...
        t2.exports = Object.setPrototypeOf || ("__proto__" in {} ? function() {
          ...
          return function(n4, r3) {
            return o2(n4), i(r3), e3 ? t3(n4, r3) : n4.__proto__ = r3, n4;
          };
        }() : void 0);
        ...
        t2.exports = function(t3, e3) {
          var n3, a;
          if ("string" === e3 && o2(n3 = t3.toString) && !i(a = r2(n3, t3))) return a;
        ...
        (O || E || S || h || d) && (g = function(t3) {
          var e3, n3, r3, o3, u2, s2, l2, h2 = this, d2 = p(h2), I = a(t3), j = d2.raw;
          if (j) return j.lastIndex = h2.lastIndex, e3 = i(g, j, I), h2.lastIndex = j.lastIndex, e3;
        ...
        var r2 = n2(1664), o2 = n2(6180), i = n2(5016), u = n2(5436), a = r2("".charAt), c = r2("".charCodeAt), s = r2("".slice), l = function(t3) {
          return function(e3, n3) {
            var r3, l2, f = i(u(e3)), p = o2(n3), h = f.length;
        ...
        t2.exports = function(t3, e3) {
          var n3 = r2(t3);
          return n3 < 0 ? o2(n3 + e3, 0) : i(n3, e3);
        };
        ...
        t2.exports = function(t3) {
          var e3 = r2(t3);
          return e3 > 0 ? o2(e3, 9007199254740991) : 0;
        };
        ...
        t2.exports = function(t3, e3) {
          ...
          var n3, c2 = u(t3, l);
          if (c2) {
            if (void 0 === e3 && (e3 = "default"), n3 = r2(c2, t3, e3), !o2(n3) || i(n3)) return n3;
        ...
        r2({ target: "Array", proto: true, arity: 1, forced: !y || !p("concat") }, { concat: function(t3) {
          var e3, n3, r3, o3, i2, u2 = a(this), p2 = f(u2, 0), h2 = 0;
          for (e3 = -1, r3 = arguments.length; e3 < r3; e3++) if (g(i2 = -1 === e3 ? u2 : arguments[e3])) for (o3 = c(i2), s(h2 + o3), n3 = 0; n3 < o3; n3++, h2++) n3 in i2 && l(p2, h2, i2[n3]);
        ...
        r2({ target: "Array", proto: true, arity: 1, forced: n2(9957)(function() {
          ...
          var e3 = o2(this), n3 = i(e3), r3 = arguments.length;
          a(n3 + r3);
          for (var c = 0; c < r3; c++) e3[n3] = arguments[c], n3++;
          return u(e3, n3), n3;
        } });
      }, 8752: function(t2, e2, n2) {
        var r2 = n2(9160), o2 = n2(6420), i = n2(908), u = n2(6488), a = "WebAssembly", c = o2[a], s = 7 !== new Error("e", { cause: 7 }).cause, l = function(t3, e3) {
          var n3 = {};
        ...
        o2("match", function(t3, e3, n3) {
          return [function(e4) {
            var n4 = s(this), o3 = u(e4) ? void 0 : l(e4, t3);
            return o3 ? r2(o3, e4, n4) : new RegExp(e4)[t3](c(n4));
          }, function(t4) {
            var r3 = i(this), o3 = c(t4), u2 = n3(e3, r3, o3);
      ...
      function r(t2) {
        ...
        var i = n[t2] = { exports: {} };
        return e[t2].call(i.exports, i, i.exports, r), i.exports;
      }
      r.d = function(t2, e2) {
      ...
      return function() {
        ...
        r(7476);
        function e2(t3, n3) {
          return e2 = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function(t4, e3) {
        ...
        var n2 = function(n3) {
          var r2, o2;
          function i2() {
            for (var t3, e3 = arguments.length, r3 = new Array(e3), o3 = 0; o3 < e3; o3++) r3[o3] = arguments[o3];
            return (t3 = n3.call.apply(n3, [this].concat(r3)) || this).state = { bump: false, debounced: false }, t3;
          }
          o2 = n3, (r2 = i2).prototype = Object.create(o2.prototype), r2.prototype.constructor = r2, e2(r2, o2);
          var u2 = i2.prototype;
          return u2.componentWillMount = function() {
            var t3, e3, r3, o3 = this;
            this.debounceStatusUpdate = (t3 = function() {
              if (!o3.state.debounced) {
                var t4 = !o3.props.isInFocus || o3.props.validChoiceMade;
                o3.setState(function(e4) {
                  return { bump: !e4.bump, debounced: true, silenced: t4 };
                });
              }
            }, e3 = 1400, function() {
            ...
            var e3 = this.props, n4 = e3.id, r3 = e3.length, o3 = e3.queryLength, i3 = e3.minQueryLength, u3 = e3.selectedOption, a2 = e3.selectedOptionIndex, c2 = e3.tQueryTooShort, s2 = e3.tNoResults, l2 = e3.tSelectedOption, f2 = e3.tResults, p = e3.className, h = this.state, d = h.bump, v = h.debounced, y = h.silenced, g = o3 < i3, m = 0 === r3, b = u3 ? l2(u3, r3, a2) : "", x = null;
        ...
        }, tSelectedOption: function(t3, e3, n3) {
          return t3 + " " + (n3 + 1) + " of " + e3 + " is highlighted";
        ...
        var f = function(e3) {
          ...
          return f2.isQueryAnOption = function(t3, e4) {
            ...
            var e4, n3 = this.state, r3 = n3.options, o3 = n3.query, i3 = n3.selected;
            this.props.confirmOnBlur ? (e4 = t3.query || o3, this.props.onConfirm(r3[i3])) : e4 = o3, this.setState({ focused: null, menuOpen: t3.menuOpen || false, query: e4, selected: null, validChoiceMade: this.isQueryAnOption(e4, r3) });
          }, f2.handleListMouseLeave = function(t3) {
            this.setState({ hovered: null });
          }, f2.handleOptionBlur = function(t3, e4) {
            var n3 = this.state, r3 = n3.focused, o3 = n3.menuOpen, i3 = n3.options, u2 = n3.selected, a2 = null === t3.relatedTarget, c2 = t3.relatedTarget === this.elementReferences[-1], s2 = r3 !== e4 && -1 !== r3;
            if (!s2 && a2 || !(s2 || c2)) {
              var f3 = o3 && l();
              this.handleComponentBlur({ menuOpen: f3, query: this.templateInputValue(i3[u2]) });
            }
          }, f2.handleInputBlur = function(t3) {
            var e4 = this.state, n3 = e4.focused, r3 = e4.menuOpen, o3 = e4.options, i3 = e4.query, u2 = e4.selected;
            if (!(-1 !== n3)) {
            ...
            var e4 = this, n3 = this.props, r3 = n3.minLength, o3 = n3.source, i3 = n3.showAllValues, u2 = this.hasAutoselect(), a2 = t3.target.value, c2 = 0 === a2.length, s2 = this.state.query !== a2, l2 = a2.length >= r3;
            this.setState({ query: a2, ariaHint: c2 }), i3 || !c2 && s2 && l2 ? o3(a2, function(t4) {
              var n4 = t4.length > 0;
              e4.setState({ menuOpen: n4, options: t4, selected: u2 && n4 ? 0 : -1, validChoiceMade: false });
            ...
            var e4 = this.state, n3 = e4.query, r3 = e4.validChoiceMade, o3 = e4.options, i3 = this.props.minLength, u2 = !r3 && n3.length >= i3 && o3.length > 0;
          ...
          }, f2.handleOptionMouseEnter = function(t3, e4) {
            l() || this.setState({ hovered: e4 });
          }, f2.handleOptionClick = function(t3, e4) {
            ...
            if (t3.preventDefault(), this.props.showAllValues && false === this.state.menuOpen) t3.preventDefault(), this.props.source("", function(t4) {
              e4.setState({ menuOpen: true, options: t4, selected: 0, focused: 0, hovered: null });
            });
            ...
            this.props.showAllValues && false === this.state.menuOpen && "" === this.state.query && (t3.preventDefault(), this.props.source("", function(t4) {
              e4.setState({ menuOpen: true, options: t4 });
            ...
            return delete et.class, (0, t2.createElement)("div", { className: V, onKeyDown: this.handleKeyDown }, (0, t2.createElement)(n2, { id: c2, length: P.length, queryLength: R.length, minQueryLength: s2, selectedOption: this.templateInputValue(P[T]), selectedOptionIndex: T, validChoiceMade: M, isInFocus: null !== this.state.focused, tQueryTooShort: y, tNoResults: g, tSelectedOption: m, tResults: b, className: U }), G && (0, t2.createElement)("span", null, (0, t2.createElement)("input", { className: [z, null === E ? S : E].filter(Boolean).join(" "), readonly: true, tabIndex: "-1", value: G })), (0, t2.createElement)("input", u({}, Y, { autoComplete: "off", className: J.join(" "), id: c2, onClick: this.handleInputClick, onBlur: this.handleInputBlur }, { onChange: this.handleInputChange }, { onFocus: this.handleInputFocus, name: f3, placeholder: p, ref: function(t3) {
            ...
            }, type: "text", role: "combobox", required: h, value: R })), e4, (0, t2.createElement)("ul", et, P.map(function(e5, n3) {
              ...
              return (0, t2.createElement)("li", { "aria-selected": C === n3 ? "true" : "false", className: "" + W + o4 + i4, dangerouslySetInnerHTML: { __html: r3.templateSuggestion(e5) + u2 }, id: c2 + "__option--" + n3, key: n3, onBlur: function(t3) {
