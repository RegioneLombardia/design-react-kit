...
const RatingBase = {
  render: ({
    ...
    return /* @__PURE__ */ React.createElement(Rating, { value, legend, inputs: ["star1a", "star2a", "star3a", "star4a", "star5a"], name: "ratingA" });
  },
  args: {
    value: 0,
    legend: "Rating"
...
const RatingConLabelWithHooks = () => {
  ...
  return /* @__PURE__ */ React.createElement(Rating, { value: rating, legend: /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("span", { className: "visually-hidden" }, "Valutazione"), " ", /* @__PURE__ */ React.createElement("span", null, rating, " stelle"), /* @__PURE__ */ React.createElement("span", { className: "visually-hidden" }, "su 5")), inputs: ["star1b", "star2b", "star3b", "star4b", "star5b"], name: "ratingB", onChangeRating: setRating });
};
...
const RatingReadOnly = {
  render: () => /* @__PURE__ */ React.createElement(Rating, { value: 4, readOnly: true, legend: {
