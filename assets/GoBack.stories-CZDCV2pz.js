...
const Esempi = {
  render: () => /* @__PURE__ */ React.createElement(GoBack, { link: true }, "Torna indietro")
};
const Pulsanti = {
  render: () => /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(GoBack, null, "Torna indietro"), " ", /* @__PURE__ */ React.createElement(GoBack, { up: true }, "Livello superiore"))
};
const PulsantiSoloIcona = {
  render: () => /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(GoBack, null), " ", /* @__PURE__ */ React.createElement(GoBack, { up: true }))
};
Esempi.parameters = {
  ...Esempi.parameters,
  docs: {
