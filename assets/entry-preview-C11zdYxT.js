const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./react-18-8CGzLhpd.js","./index-CkHlViRq.js","./_commonjsHelpers-CcAunmGO.js","./client-C212XDUy.js","./index-rIQx-mDE.js"])))=>i.map(i=>d[i]);
...
import { a as requireReact, r as reactExports, e } from "./index-CkHlViRq.js";
import { r as reactDomExports } from "./index-rIQx-mDE.js";
 ...
 */
var k = requireReact(), l = reactDomExports;
function m(a) {
  var b = a, c = a;
...
async function renderToCanvas({ storyContext, unboundStoryFn, showMain, showException, forceRemount }, canvasElement) {
  let { renderElement, unmountElement } = await __vitePreload(async () => {
    const { renderElement: renderElement2, unmountElement: unmountElement2 } = await import("./react-18-8CGzLhpd.js");
