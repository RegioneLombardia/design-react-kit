...
const EsempioInterattivo = {
  render: ({
    ...args
  }) => /* @__PURE__ */ React.createElement(Badge, { ...args }, "Badge"),
  parameters: {
    layout: "centered"
  }
};
const DiffenteGrandezza = {
  render: () => /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h1", null, "Titolo di esempio ", /* @__PURE__ */ React.createElement(Badge, { color: "secondary" }, "New")), /* @__PURE__ */ React.createElement("h2", null, "Titolo di esempio ", /* @__PURE__ */ React.createElement(Badge, { color: "secondary" }, "New")), /* @__PURE__ */ React.createElement("h3", null, "Titolo di esempio ", /* @__PURE__ */ React.createElement(Badge, { color: "secondary" }, "New")), /* @__PURE__ */ React.createElement("h4", null, "Titolo di esempio ", /* @__PURE__ */ React.createElement(Badge, { color: "secondary" }, "New")), /* @__PURE__ */ React.createElement("h5", null, "Titolo di esempio ", /* @__PURE__ */ React.createElement(Badge, { color: "secondary" }, "New")), /* @__PURE__ */ React.createElement("h6", null, "Titolo di esempio ", /* @__PURE__ */ React.createElement(Badge, { color: "secondary" }, "New")))
};
const Contatore = {
  render: () => /* @__PURE__ */ React.createElement(Button, { color: "primary" }, "Notifiche ", /* @__PURE__ */ React.createElement(Badge, { color: "light", className: "text-secondary" }, "4"))
};
const ContatoreTestoAggiuntivo = {
  render: () => /* @__PURE__ */ React.createElement(Button, { color: "primary" }, "Notifiche ", /* @__PURE__ */ React.createElement(Badge, { color: "light", className: "text-primary" }, "9"), /* @__PURE__ */ React.createElement("span", { className: "visually-hidden" }, "Messaggi non letti"))
};
const Variazioni = {
  render: () => /* @__PURE__ */ React.createElement("div", { className: "d-flex justify-content-around" }, /* @__PURE__ */ React.createElement(Badge, { color: "primary" }, "Primary"), /* @__PURE__ */ React.createElement(Badge, { color: "secondary" }, "Secondary"), /* @__PURE__ */ React.createElement(Badge, { color: "success" }, "Success"), /* @__PURE__ */ React.createElement(Badge, { color: "danger" }, "Danger"), /* @__PURE__ */ React.createElement(Badge, { color: "warning" }, "Warning"))
};
const BordiArrotondati = {
  render: () => /* @__PURE__ */ React.createElement("div", { className: "d-flex justify-content-around" }, /* @__PURE__ */ React.createElement(Badge, { color: "primary", pill: true }, "Primary"), /* @__PURE__ */ React.createElement(Badge, { color: "secondary", pill: true }, "Secondary"), /* @__PURE__ */ React.createElement(Badge, { color: "success", pill: true }, "Success"), /* @__PURE__ */ React.createElement(Badge, { color: "danger", pill: true }, "Danger"), /* @__PURE__ */ React.createElement(Badge, { color: "warning", pill: true }, "Warning"))
};
const ConLink = {
  render: () => /* @__PURE__ */ React.createElement("div", { className: "d-flex justify-content-around" }, /* @__PURE__ */ React.createElement(Badge, { href: "#", color: "primary", tag: "a" }, "Primary"), /* @__PURE__ */ React.createElement(Badge, { href: "#", color: "secondary", tag: "a" }, "Secondary"), /* @__PURE__ */ React.createElement(Badge, { href: "#", color: "success", tag: "a" }, "Success"), /* @__PURE__ */ React.createElement(Badge, { href: "#", color: "danger", tag: "a" }, "Danger"), /* @__PURE__ */ React.createElement(Badge, { href: "#", color: "warning", tag: "a" }, "Warning"))
};
