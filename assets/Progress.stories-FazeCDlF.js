...
const Esempio = {
  render: () => /* @__PURE__ */ React.createElement(Progress, { value: "50" })
};
const Etichette = {
  render: () => /* @__PURE__ */ React.createElement(Progress, { value: "35", label: "progresso" })
};
const ProgressoIndeterminato = {
  render: () => /* @__PURE__ */ React.createElement(Progress, { indeterminate: true, label: "In elaborazione..." })
};
const Colori = {
  render: () => /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(Progress, { value: "25", color: "success" }), /* @__PURE__ */ React.createElement(Progress, { value: "33", color: "info" }), /* @__PURE__ */ React.createElement(Progress, { value: "50", color: "warning" }), /* @__PURE__ */ React.createElement(Progress, { value: "66", color: "danger" }))
};
const BottoneConProgressBar = {
  render: () => /* @__PURE__ */ React.createElement("div", { className: "container" }, /* @__PURE__ */ React.createElement("div", { className: "row" }, /* @__PURE__ */ React.createElement("div", { className: "col-12 col-sm-6" }, /* @__PURE__ */ React.createElement("p", null, /* @__PURE__ */ React.createElement("strong", null, "Bottone primario")), /* @__PURE__ */ React.createElement(Button, { color: "primary", className: "btn-progress", disabled: true }, "Label bottone ", /* @__PURE__ */ React.createElement(Icon, { color: "light", icon: "it-github", "aria-hidden": true }), /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement(Progress, { value: "50" })))), /* @__PURE__ */ React.createElement("div", { className: "col-12 col-sm-6" }, /* @__PURE__ */ React.createElement("p", null, /* @__PURE__ */ React.createElement("strong", null, "Bottone secondario")), /* @__PURE__ */ React.createElement(Button, { color: "secondary", className: "btn-progress", disabled: true }, "Label bottone ", /* @__PURE__ */ React.createElement(Icon, { color: "light", icon: "it-github", "aria-hidden": true }), /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement(Progress, { value: "50" }))))))
};
const _EsempiInterattivi = {
  render: ({
    ...
    return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(Progress, { value, label, color }));
  },
  args: {
    color: "",
    value: 25,
