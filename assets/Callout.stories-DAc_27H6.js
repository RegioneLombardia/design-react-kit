...
const EsempioBasico = {
  render: () => /* @__PURE__ */ React.createElement(Callout, null, /* @__PURE__ */ React.createElement(CalloutTitle, null, /* @__PURE__ */ React.createElement("span", { className: "text" }, "Titolo Callout")), /* @__PURE__ */ React.createElement(CalloutText, null, "Maecenas vulputate ante dictum vestibulum volutpat. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean non augue non purus vestibulum varius."))
};
const EsempioConIcona = {
  render: () => /* @__PURE__ */ React.createElement(Callout, null, /* @__PURE__ */ React.createElement(CalloutTitle, null, /* @__PURE__ */ React.createElement(Icon, { icon: "it-info-circle", padding: false, "aria-hidden": true }), /* @__PURE__ */ React.createElement("span", { className: "visually-hidden" }, "Confermato"), /* @__PURE__ */ React.createElement("span", { className: "text" }, "Titolo Callout")), /* @__PURE__ */ React.createElement(CalloutText, null, "Maecenas vulputate ante dictum vestibulum volutpat. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean non augue non purus vestibulum varius."))
};
const EsempioAccessibilita = {
  render: () => /* @__PURE__ */ React.createElement(Callout, null, /* @__PURE__ */ React.createElement(CalloutTitle, null, /* @__PURE__ */ React.createElement(Icon, { icon: "it-check-circle", padding: false, "aria-hidden": true }), /* @__PURE__ */ React.createElement("span", { className: "visually-hidden" }, "Confermato"), /* @__PURE__ */ React.createElement("span", { className: "text" }, "Titolo Callout")), /* @__PURE__ */ React.createElement(CalloutText, null, "Maecenas vulputate ante dictum vestibulum volutpat. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean non augue non purus vestibulum varius."))
};
const CalloutVariantiColore = {
  render: ({
    ...args
  }) => /* @__PURE__ */ React.createElement(Callout, { color: args.color }, /* @__PURE__ */ React.createElement(CalloutTitle, null, /* @__PURE__ */ React.createElement(Icon, { icon: `it-${args.icon}-circle`, padding: false, "aria-hidden": true }), /* @__PURE__ */ React.createElement("span", { className: "text" }, args.title)), /* @__PURE__ */ React.createElement(CalloutText, null, "Maecenas vulputate ante dictum vestibulum volutpat. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean non augue non purus vestibulum varius.")),
  parameters: {
    docs: {
      controls: {
...
const CalloutHighlights = {
  render: ({
    ...args
  }) => /* @__PURE__ */ React.createElement(Callout, { highlight: true, color: args.color }, /* @__PURE__ */ React.createElement(CalloutTitle, null, /* @__PURE__ */ React.createElement(Icon, { icon: `it-${args.icon}-circle`, padding: false, "aria-hidden": true }), args.title), /* @__PURE__ */ React.createElement(CalloutText, null, "Maecenas at erat id sem interdum efficitur eu sed nunc. Mauris sit amet erat eget augue molestie malesuada ut sed ex. In sed dignissim elit."), /* @__PURE__ */ React.createElement(CalloutText, null, "Maecenas vulputate ante dictum vestibulum volutpat. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean non augue non purus vestibulum varius. Maecenas ullamcorper ", /* @__PURE__ */ React.createElement("a", { href: "#" }, "tincidunt nulla quis laoreet."))),
  parameters: {
    docs: {
      controls: {
        exclude: ["title", "className", "tag", "title", "highlight", "detailed", "testId"]
