...
const Small = {
  render: (args) => /* @__PURE__ */ React.createElement(BackToTop, { ...args }),
  args: {
    small: true
  }
};
const Shadow = {
  render: () => /* @__PURE__ */ React.createElement("div", { className: "d-flex align-items-center" }, /* @__PURE__ */ React.createElement(BackToTop, { shadow: true }), /* @__PURE__ */ React.createElement(BackToTop, { shadow: true, small: true }))
};
const Dark = {
  render: () => /* @__PURE__ */ React.createElement("div", { className: "d-flex align-items-center" }, /* @__PURE__ */ React.createElement(BackToTop, { dark: true }), /* @__PURE__ */ React.createElement(BackToTop, { dark: true, small: true }))
};
const DarkShadow = {
  render: () => /* @__PURE__ */ React.createElement("div", { className: "d-flex align-items-center" }, /* @__PURE__ */ React.createElement(BackToTop, { dark: true, shadow: true }), /* @__PURE__ */ React.createElement(BackToTop, { dark: true, shadow: true, small: true }))
};
Esempio.parameters = {
  ...Esempio.parameters,
  docs: {
